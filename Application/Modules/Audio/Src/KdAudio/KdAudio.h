...
// サウンドアセットの管理
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
class KdAudioManager :public IAudio
{
public:
	KdAudioManager() = default;
	virtual ~KdAudioManager()override = default;


	void SetListnerMatrix(const Math::Matrix& mWorld)override;

	// サウンド再生
	std::shared_ptr<ISoundInstance>   Play(std::string_view rName, bool loop = false)override;
	std::shared_ptr<ISoundInstance3D> Play3D(std::string_view rName, const Math::Vector3& rPos, bool loop = false)override;

	void AddPlayList(const std::shared_ptr<ISoundInstance>& rSound)override;
	...
	// サウンドアセットの一括読込
	void LoadSoundAssets(std::initializer_list<std::string_view>& fileName)override;
private:
	bool Entry()override;
	...
	// 再生中のサウンドリスト
	std::map<size_t, std::shared_ptr<ISoundInstance>>	m_playList;
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
class KdSoundInstance 
	: public ISoundInstance
	, public std::enable_shared_from_this<KdSoundInstance>
...
public:
	...
	void Stop() override	{ if (m_instance) { m_instance->Stop(); } }
	void Pause()override	{ if (m_instance) { m_instance->Pause(); } }
	void Resume()override	{ if (m_instance) { m_instance->Resume(); } }
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
class KdSoundInstance3D : public ISoundInstance3D
{
public:
	...
	void SetPos(const DirectX::SimpleMath::Vector3& rPos);
